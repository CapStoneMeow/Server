    ...
    prompt = [
        {
            ...
            "content": (
                ...
                "반드시 아래에 주어진 단어가 그대로 포함된 문장으로만 수정해줘. "
                "문장의 자연스러움, 문맥 적절성, 문법적 오류를 고려해 한 문장으로만 수정 제안해줘. "
                "초등학생이니까 너무 문장을 길게 쓰진 말아줘. 단순하게 해줘."
                "동의어나 유사어로 바꾸거나 단어를 빼지 마. "
                f"반드시 포함해야 하는 단어: '{input_data.word}'. "
    ...
    messages = [
        {
            ...
            "content": (
                ...
                "카테고리(일상대화, 사회, 자연, 건강, 예술)에 맞춰 질문을 해. "
                "문장은 한 문장으로 끝내줘."
            )
        },
        {
